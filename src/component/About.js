...
function InfoCard(props) {
  ...
  return (
    <motion.div layout  transition={{staggerChildren: 0.9}} className='px-4 lg:pl-12 xl:pl-48 2xl:pl-72 landscape:h-full portrait:h-screen sm:portrait:h-screen sm:landscape:h-full md:landscape:h-screen md:portrait:h-screen flex items-center justify-center  '>
